...
RSpec.describe Experiment do
  ...
  it "#long_running_experiments" do
    expect(Experiment.long_running_experiments).to eq([@double_helix, @laws_of_motion])
  end

  it "#names_in_descending_order" do
    expect(Experiment.names_in_descending_order).to eq([@laws_of_motion, @double_helix, @minerva])
  end
end